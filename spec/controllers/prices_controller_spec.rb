...
RSpec.describe PricesController, type: :controller do
  describe 'GET#index' do
    ...
    it 'assigns @prices' do
      ...
      stock1_price1 = stock1.prices.create(date: DateTime.now, price: 12.55)
      stock1_price2 = stock1.prices.create(date: 1.day.ago, price: 22.55)
      ...
      expect(assigns(:prices).map(&:id)).to eq [stock1_price2.id, stock1_price1.id]
    end
  end
end
